...
(function() {
  ...
  select = function() {
    var i, pick, _i, _j, _ref, _ref1, _results;
    show = [];
    target = [];
    for (i = _i = 0, _ref = SHOW - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    target = [];
    _results = [];
    for (i = _j = 0, _ref1 = TARGET - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
  ...
  youreDone = function() {
    var fnd, msd, t, _i, _j, _len, _len1;
    fnd = 0;
